...
const file_login_v1_login_proto_rawDesc = "" +
	"\n" +
	"\x14login/v1/login.proto\x12\blogin.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\"N\n" +
	"\fLoginRequest\x12\x1d\n" +
	"\aaccount\x18\x01 \x01(\tB\x03\xe0A\x02R\aaccount\x12\x1f\n" +
	"\bpassword\x18\x02 \x01(\tB\x03\xe0A\x02R\bpassword\"\xab\x01\n" +
	"\n" +
	"LoginReply\x12!\n" +
...
var file_login_v1_login_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
