...
type Video struct {
	...
	CpId                int64                  `protobuf:"varint,16,opt,name=cp_id,json=cpId,proto3" json:"cp_id,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_vod_v1_vod_proto_rawDesc = "" +
	...
	"\bcategory\x18\x01 \x01(\v2\x10.vod.v1.CategoryB\x04\xe2A\x01\x02R\bcategory\"\xaa\x04\n" +
	"\x05Video\x12\x0e\n" +
	...
	"updateTime\x12\x13\n" +
	"\x05cp_id\x18\x10 \x01(\x03R\x04cpId\"1\n" +
	"\bVideoSet\x12%\n" +
	"\x06videos\x18\x01 \x03(\v2\r.vod.v1.VideoR\x06videos\"?\n" +
	"\x12CreateVideoRequest\x12)\n" +
	"\x05video\x18\x01 \x01(\v2\r.vod.v1.VideoB\x04\xe2A\x01\x02R\x05video\"'\n" +
	"\x0fGetVideoRequest\x12\x14\n" +
	"\x02id\x18\x01 \x01(\x03B\x04\xe2A\x01\x02R\x02id\"N\n" +
	...
	"\x02id\x18\x01 \x01(\x03B\x04\xe2A\x01\x02R\x02id\"\xb9\x02\n" +
	"\aEpisode\x12\x0e\n" +
	...
	"\n" +
	"EpisodeSet\x12+\n" +
	"\bepisodes\x18\x01 \x03(\v2\x0f.vod.v1.EpisodeR\bepisodes\"G\n" +
	"\x14CreateEpisodeRequest\x12/\n" +
	"\aepisode\x18\x01 \x01(\v2\x0f.vod.v1.EpisodeB\x04\xe2A\x01\x02R\aepisode\"6\n" +
	"\x13ListEpisodesRequest\x12\x1f\n" +
	"\bvideo_id\x18\x01 \x01(\x03B\x04\xe2A\x01\x02R\avideoId\",\n" +
	"\x14DeleteEpisodeRequest\x12\x14\n" +
	"\x02id\x18\x01 \x01(\x03B\x04\xe2A\x01\x02R\x02id\"\xaf\x03\n" +
	"\x05Media\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x19\n" +
	"\bvideo_id\x18\x02 \x01(\x03R\avideoId\x12\x1d\n" +
	"\n" +
	...
	"\x05media\x18\x01 \x01(\v2\r.vod.v1.MediaB\x04\xe2A\x01\x02R\x05media\"7\n" +
	"\x10ListMediaRequest\x12#\n" +
	"\n" +
	"episode_id\x18\x01 \x01(\x03B\x04\xe2A\x01\x02R\tepisodeId\"*\n" +
	"\x12DeleteMediaRequest\x12\x14\n" +
	"\x02id\x18\x01 \x01(\x03B\x04\xe2A\x01\x02R\x02id2\xb3\t\n" +
	"\n" +
	"VodService\x12b\n" +
