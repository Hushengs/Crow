...
func (x *Auth_JWT) GetExpiresIn() int64 {
	if x != nil {
		return x.ExpiresIn
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"l\n" +
	"\x04Auth\x12&\n" +
	"\x03jwt\x18\x01 \x01(\v2\x14.kratos.api.Auth.JWTR\x03jwt\x1a<\n" +
	"\x03JWT\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\tR\x06secret\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x02 \x01(\x03R\texpiresInB\x19Z\x17crow/internal/conf;confb\x06proto3"
